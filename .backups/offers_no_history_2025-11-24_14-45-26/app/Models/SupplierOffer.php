...
class SupplierOffer extends Model
{
    ...
    /**
     * Alias used in controllers/views: $offer->connection
     * so ->with('connection') works.
     */
    ...
    /**
     * Full history entries for this offer.
     */
    public function history()
    {
        return $this->hasMany(SupplierOfferHistory::class, 'supplier_offer_id');
    }

    /**
     * Latest history entry (used by ->with('latestHistory')).
     */
    public function latestHistory()
    {
        return $this->hasOne(SupplierOfferHistory::class, 'supplier_offer_id')->latestOfMany();
    }
}
