        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" action="{{ route('offers.index') }}" class="mb-4">
                <div class="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-3">
                    ...
                    {{-- Charge Model --}}
                    <div>
                        <label for="filter_charge_model_id" class="block text-xs font-medium text-gray-700">
                            {{ __('Charge Model') }}
                        </label>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @forelse ($offers as $offer)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-3 py-2 text-xs whitespace-nowrap font-mono">
                                        {{ $offer->mcc_mnc ?? '-' }}
                                    </td>
                                    <td class="px-3 py-2 text-xs whitespace-nowrap">
                                        {{ $offer->supplier_name ?? '-' }}
                                    ...
                                    <td class="px-3 py-2 text-xs whitespace-nowrap">
                                        {{ $offer->connection_name ?? '-' }}
                                    </td>
                                    <td class="px-3 py-2 text-xs whitespace-nowrap font-mono">
                                        {{ $offer->connection_username ?? '-' }}
                                    </td>
                                    <td class="px-3 py-2 text-xs whitespace-nowrap">
