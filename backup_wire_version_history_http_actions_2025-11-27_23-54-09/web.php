...
use App\Http\Controllers\VersionHistorySnapshotsController;
...
Route::middleware(['web', 'auth'])->get(
    ...
    [\App\Http\Controllers\VersionHistoryController::class, 'index']
)->name('settings.version-history.index');

Route::middleware(['web', 'auth'])->post(
    '/settings/version-history/rollback',
    [\App\Http\Controllers\VersionHistoryController::class, 'rollback']
)->name('settings.version-history.rollback');
