      ...
      <table class="min-w-full text-sm">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="px-4 py-2 text-left font-semibold text-gray-700">Module</th>
        ...
        <tbody>
          @forelse($menus as $menu)
            <tr class="border-t">
              ...
              <td class="px-4 py-2 text-gray-800">{{ $menu->module ?: '-' }}</td>
          ...
          @empty
            <tr class="border-t">
              <td colspan="5" class="px-4 py-6 text-center text-gray-500">No menus yet. Create one.</td>
            </tr>
          @endforelse
        </tbody>
      </table>
