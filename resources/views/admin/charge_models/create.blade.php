<x-app-layout>
  <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800">New Charge Models</h2></x-slot>
  <div class="py-6"><div class="max-w-xl mx-auto sm:px-6 lg:px-8"><div class="bg-white p-6 shadow sm:rounded-lg">
    <form method="POST" action="{{ route('admin/charge_models.store') }}" class="space-y-4">
      @csrf
