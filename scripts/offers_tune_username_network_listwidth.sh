...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_tune_username_network_listwidth_$(date +%F_%H-%M-%S)"
...
############################################################
# 1) Unified Create/Edit form with:
#    - MCC/MNC next to network name
#    - Dynamic connection username
############################################################
...
############################################################
# 2) List view: delete button, editor name, full-width table
############################################################
...
<x-app-layout>
    ...
    <div class="py-6 w-full max-w-full px-2 sm:px-4 lg:px-6 mx-auto">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-4 w-full">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('offers.create') }}"
                   class="inline-flex items-center gap-2 px-4 py-2 border border-green-700 text-sm font-semibold rounded-md shadow-sm bg-white text-green-700 hover:bg-green-50">
        ...
        {{-- Full-width table with scroll if needed --}}
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-3 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Conn. Username</th>
                        ...
                        <th class="px-3 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Last Edited</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Edited By</th>
                    ...
                    @forelse($offers as $offer)
                        <tr>
                            ...
                            <td class="px-3 py-2 align-top whitespace-nowrap">
                                @php
                                    $editorName = null;
                                    if (!empty($offer->updated_by_user_id ?? null)) {
                                        $editor = \App\Models\User::find($offer->updated_by_user_id);
