...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_index_force_create_$(date +%F_%H-%M-%S)"
...
echo "==> Rewriting resources/views/offers/index.blade.php (always show Create Offer button)"
...
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            ...
            {{-- Create Offer button (πάντα εμφανές, link στο offers.create) --}}
