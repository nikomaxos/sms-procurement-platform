...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_4cols_layout_strict_$(date +%F_%H-%M-%S)"
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            >
                ...
                <div class="gap-4" style="display:flex;flex-wrap:wrap;">
                    ...
                    <div style="flex:0 0 25%;max-width:25%;" class="pr-2 mb-4">
                    ...
                    <div style="flex:0 0 25%;max-width:25%;" class="px-1 mb-4">
                    ...
                    {{-- Supplier --}}
                    <div style="flex:0 0 25%;max-width:25%;" class="pl-2 mb-4">
                ...
                <div class="gap-4 mt-2" style="display:flex;flex-wrap:wrap;">
