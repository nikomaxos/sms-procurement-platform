...
BACKUP_DIR="$BACKUP_ROOT/ui_networks_filters_horizontal_${TS}"

mkdir -p "$LOG_DIR" "$BACKUP_DIR"

LOG_FILE="$LOG_DIR/ui_networks_filters_horizontal_${TS}.log"
...
# -------------------------------------------------------------------
# 2) Rewrite networks/index.blade.php with horizontal filters
# -------------------------------------------------------------------
echo "==> Rewriting networks index view (horizontal filters)" | tee -a "$LOG_FILE"
...
# -------------------------------------------------------------------
# 3) Clear & cache views via docker compose
# -------------------------------------------------------------------
