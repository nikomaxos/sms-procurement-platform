...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_fix_edit_form_layout_$(date +%F_%H-%M-%S)"
...
if [ -f "resources/views/offers/edit.blade.php" ]; then
  ...
  echo "!! resources/views/offers/edit.blade.php not found. Aborting."
  exit 0
fi
    ...
    <div class="py-6 w-full max-w-full px-2 sm:px-4 lg:px-6 mx-auto">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            >
                ...
                {{-- Price (locked on edit, visually greyed) --}}
                <div>
...
echo "==> edit.blade.php rewritten. Backups at: ${BACKUP_DIR}"
