...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_index_labels_and_edited_by_$(date +%F_%H-%M-%S)"
    ...
    <div class="py-6 w-full max-w-full px-2 sm:px-4 lg:px-6 mx-auto">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-4">
            <form method="GET" action="{{ route('offers.index') }}" class="space-y-4">
                ...
                {{-- 2 σειρές x 4 φίλτρα --}}
                <div class="space-y-4">
                    {{-- Row 1: Country, Network, Supplier, Connection --}}
                    <div class="flex -mx-2">
                        ...
                        {{-- Network: shortlist by selected country + MCCMNC --}}
                        <div class="flex-1 px-2">
