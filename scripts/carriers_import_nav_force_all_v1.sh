...
BACKUP_DIR="$BACKUP_ROOT/carriers_import_nav_force_all_${TS}"

mkdir -p "$LOG_DIR" "$BACKUP_DIR"

LOG_FILE="$LOG_DIR/carriers_import_nav_force_all_${TS}.log"
...
#    Minimal Breeze-Style layout using layouts.navigation
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 4) Clear & rebuild Blade cache via app service
# -------------------------------------------------------------------
