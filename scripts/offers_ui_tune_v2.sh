...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_ui_v2_$(date +%F_%H-%M-%S)"
...
#############################################
# 1) INDEX VIEW (Create button + Edited By)
#############################################
    ...
    <div class="py-6 w-full max-w-full px-2 sm:px-4 lg:px-6 mx-auto">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-4 w-full">
            <div class="flex items-center justify-between mb-4">
                ...
                {{-- Create Offer button με readable styling (σκούρο text σε λευκό φόντο) --}}
...
#############################################
# 2) CREATE VIEW (MCC/MNC label + dropdown charge_type + connection defaults)
#############################################
