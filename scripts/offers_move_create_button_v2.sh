...
BACKUP_DIR="backup_offers_move_create_button_v2_$(date +%F_%H-%M-%S)"
mkdir -p "$BACKUP_DIR/resources/views/offers"
cp resources/views/offers/index.blade.php "$BACKUP_DIR/resources/views/offers/index.blade.php" || true

cat > resources/views/offers/index.blade.php << 'PHP'
<x-app-layout>
    <x-slot name="header">
...
echo "==> Rewrote resources/views/offers/index.blade.php; backup at $BACKUP_DIR"
