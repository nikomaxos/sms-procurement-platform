...
BACKUP_DIR="$ROOT/backup_fix_version_snapshot_${TIMESTAMP}"
LOG_DIR="$ROOT/logs"
LOG_FILE="$LOG_DIR/fix_version_snapshot_for_container_${TIMESTAMP}.log"
...
# Backup existing version_snapshot.sh if present
...
echo "==> Writing new scripts/version_snapshot.sh (host + container aware)..."
...
echo "==> You can manually restore it with:"
echo "   cp \"$BACKUP_DIR/version_snapshot.sh\" \"$SNAPSHOT_SCRIPT\"  # if needed"
