...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_fix_filters_and_edit_layout_$(date +%F_%H-%M-%S)"
...
#    - Inline filters (no missing partial)
#    - Effective Date column
#    - Last Edited in Europe/Athens
#    - Edited By name
...
#    - 4 fields per row on md+ screens
#    - Connection username right after connection
#    - All three buttons bottom-right (Back, Save, Delete)
#      using external submit button (form="offer-main-form")
###############################################
