...
# -------------------------------------------------------------------
# 1) Rewrite navigation.blade.php with left-nav Carriers Import (admin-only)
# -------------------------------------------------------------------
...
echo "==> navigation.blade.php rewritten with left-nav Carriers Import (admin only)" | tee -a "$LOG_FILE"
...
echo "==> carriers_import_admin_link_v8.sh completed successfully." | tee -a "$LOG_FILE"
