# scripts/patch_iso2_null_and_rerun.sh
#!/usr/bin/env bash
set -Eeuo pipefail
trap 'echo "[ERR] line $LINENO: $BASH_COMMAND" >&2' ERR

IMPCMD="app/Console/Commands/ImportCarriers.php"
mkdir -p "$(dirname "$IMPCMD")"
...
echo "==> Re-run import inside container"
if docker compose version >/dev/null 2>&1; then DC="docker compose"; else DC="docker-compose"; fi
$DC exec -T app sh -lc 'php artisan optimize:clear && php artisan carriers:import --fresh'
echo "Done."
