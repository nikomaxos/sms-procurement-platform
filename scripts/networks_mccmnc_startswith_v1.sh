...
BACKUP_DIR="$BACKUP_ROOT/networks_mccmnc_startswith_v1_${TS}"

mkdir -p "$LOG_DIR" "$BACKUP_DIR"

LOG_FILE="$LOG_DIR/networks_mccmnc_startswith_v1_${TS}.log"
...
echo "==> Rewriting networks index view with MCCMNC STARTS-WITH filter" | tee -a "$LOG_FILE"
...
echo "==> networks_mccmnc_startswith_v1.sh completed successfully." | tee -a "$LOG_FILE"
