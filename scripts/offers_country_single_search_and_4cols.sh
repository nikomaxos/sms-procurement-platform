...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_country_single_search_and_4cols_$(date +%F_%H-%M-%S)"
...
#    - Country: single select + search while typing
###############################################
...
<x-app-layout>
    ...
    <div class="py-6 w-full max-w-full px-2 sm:px-4 lg:px-6 mx-auto">
        ...
        <form method="GET"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {{-- Country: single select with search-while-typing --}}
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Start typing while the dropdown is focused to search by name.
                    </p>
                </div>
    ...
    <script>
        // Search-while-typing inside single select for countries (substring match).
