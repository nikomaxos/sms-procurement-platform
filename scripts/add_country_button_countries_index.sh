...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_countries_index_$(date +%F_%H-%M-%S)"
...
echo "==> Rewriting resources/views/countries/index.blade.php with Add Country button..."
...
<x-app-layout>
    ...
    <div class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        <div class="overflow-x-auto rounded-lg border bg-white">
            {{-- Add Country button inside results frame, top-right, light green --}}
...
echo "==> Done. File rewritten. Backup stored in ${BACKUP_DIR}"
