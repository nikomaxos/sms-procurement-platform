...
echo "==> Step6 v4: Networks index filters + CSV export + UI polish (with backup & restore)"
...
cat > tools/patches/patch_networks_index_v4.php <<'PHP'
<?php
$F = 'app/Http/Controllers/NetworksController.php';
...
# Execute patcher
$DC exec -T app php tools/patches/patch_networks_index_v4.php
