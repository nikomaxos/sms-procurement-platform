...
PROJECT_ROOT="$(pwd)"
BACKUP_DIR="${PROJECT_ROOT}/backup_offers_index_fix_$(date +%F_%H-%M-%S)"
...
echo "==> Rewriting resources/views/offers/index.blade.php with full-width layout and horizontal scroll"
